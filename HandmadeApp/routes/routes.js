...
router.get("/admin/allUsers",auth.userAuth, userController.showAll);/**adminAuth will be add after admin contoller*/
router.patch("/edit",auth.userAuth, userController.edit);
router.patch("/editPassword",auth.userAuth, userController.editPassword);
router.patch("/resetPassword", userController.forgotPassword);
router.delete("/delete",auth.userAuth, userController.remove);
router.delete("/admin/deleteUser/:id",auth.userAuth, userController.removeUser);/**adminAuth will be add after admin contoller*/
